...
using VoucherWarehouse.Models.TokenAuth;
...
public abstract class VoucherWarehouseWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static VoucherWarehouseWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(VoucherWarehouseWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<VoucherWarehouseDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<VoucherWarehouseDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<VoucherWarehouseDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<VoucherWarehouseDbContext, Task<T>> func)
    {
        T result;
