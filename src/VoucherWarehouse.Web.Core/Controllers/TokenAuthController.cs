...
using IBS.VoucherWarehouse.Authentication.JwtBearer;
using IBS.VoucherWarehouse.Models.TokenAuth;
...
public class TokenAuthController : VoucherWarehouseControllerBase
{
