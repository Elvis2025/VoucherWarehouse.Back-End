...
public class RolePermissions : PermissionBase
{
    ...
    public override void Set(IPermissionDefinitionContext context)
    {
        ...
        var roles = context.CreatePermission(PermissionNames.Pages_Roles, L("Roles"));
            ...
            roles.CreateChildPermission(PermissionNames.Pages_Roles_Permissions, L("RolesPermissions"));
            roles.CreateChildPermission(PermissionNames.Pages_Roles_AssignmentUser, L("RolesAssignmentUser"));
    }
