...
public class DefaultLanguagesCreator
{
    ...
    {
        var tenantId = VoucherWarehouseConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
    ...
    public DefaultLanguagesCreator(VoucherWarehouseDbContext context)
    {
        _context = context;
    }
